            ...
            <div class="flex justify-around">
                <div class="">
                    <div class="my-12">
                        ...
                        <form action="{{ route('userposts.store') }}" method="POST" class="form-lapor flex gap-5 my-4"
                            ...
                            <div class="">
                                ...
                                <label class="form-control w-full max-w-xs" for="isi_laporan">
                                    ...
                                    <textarea class="textarea textarea-bordered" placeholder="Isi laporan" name="isi_laporan"></textarea>
